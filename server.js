...
// =================================================
// AUTENTICAÇÃO CONTROLO DE ENTRADA
// =================================================
...
// Esta rota é utilizada pelo convite.html
// =================================================
...
// =================================================
// CONSULTAR CONVIDADO
// Esta é a rota utilizada pelo entrada.html
// =================================================
...
app.post(
    ...
    (req, res) => {
        ...
        const convidado = db
            .prepare(
                "SELECT * FROM convidados WHERE codigo=?"
            )
            .get(codigo);
